...
function BounceButton({text, startTextColor, endTextColor, componentBefore}) {
  ...
  return (
    ...
    >
      <span
        className="relative transition-colors duration-200 ease-in-out gap-2 flex items-center px-[16px] py-[6px] overflow-hidden border rounded-lg bg-gradient-to-t from-[#FDD15A] to-[#FDB04F]"
      ...
      >
        ...
        <span
            ...
            animation: hovered ? "fill-bounce 0.8s forwards" : "none",
            }}
        ></span>
      </span>
    </button>
    ...
    return (
        <header className="pt-[22px]">
            ...
            <div className="w-full flex items-start justify-between">
                <Link to="/"><img src="src/assets/headd.png" alt="logo" style={{width: '150px'}} /></Link>
            ...
            <div className={`w-full ${windowWidth < 768 ? 'px-6' : ''}`}>
                <div className="flex items-start justify-between">
                    <Link to="/"><img src="src/assets/headd.png" alt="logo" style={{width: '90px'}} /></Link>
